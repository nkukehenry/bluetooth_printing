...
//            } else {
     ...
     * @throws IOException
     */
    public void printText20(String text) throws IOException {
        mWriter.write(0x1b);
        mWriter.write(0x21);
        mWriter.write(20);
        mWriter.write(text);
     ...
     * @throws IOException
     */
    public void printText16(String text) throws IOException {
        mWriter.write(0x1b);
        mWriter.write(0x21);
        mWriter.write(20);
        mWriter.write(text);
     ...
     * @throws IOException
     */
    public void printText14(String text) throws IOException {
        mWriter.write(0x1b);
        mWriter.write(0x21);
        mWriter.write(20);
        mWriter.write(text);
    ...
    public static void printTest(BluetoothSocket bluetoothSocket, Bitmap bitmap) {
        ...
        try {
            PrintUtil pUtil = new PrintUtil(bluetoothSocket.getOutputStream(), "UTF-8");
            // 店铺名 居中 放大
            pUtil.printAlignment(1);
            pUtil.printText("各国语言打印测试");
            pUtil.printLine();
            pUtil.printText("National language printing test\n");
            pUtil.printLine();
            pUtil.printText14(" \nطباعة اختبار اللغة");
            pUtil.printLine();
            pUtil.printText14("Ulusal dil yazdırma sınaması\n");
            pUtil.printLine();
            pUtil.printText16("Testi kombëtar i printimit të gjuhës\n");
            pUtil.printLine();
            pUtil.printText16("тест на печатание на языках по странам\n");
            pUtil.printLine();
            pUtil.printText20("Tests d'impression dans les langues nationales\n");
            pUtil.printLine();
            pUtil.printText20("各国言語印刷テスト\n");
            pUtil.printLine();
            pUtil.printText20("Tástáil phriontála teanga náisiúnta\n");
            pUtil.printLine();
            pUtil.printText("ნაციონალური ენის დამატება ტესტი\n");
            pUtil.printLine();
